 ...
 */
final class Version20190522095953 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pokemon_team (id INT AUTO_INCREMENT NOT NULL, surnom_pokemon VARCHAR(255) NOT NULL, pokemon_hp INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
